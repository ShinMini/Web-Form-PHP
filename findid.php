...
<body>
  ...
  <section class="contain">
    <form class="login" action="findidproc.php" method="POST" target="_self">
      <input type="text" name="name" class="login_ID" placeholder="이름을 입력해주세요">
      <input type="text" name="tel" class="login_PWD" placeholder="전화번호를 입력해주세요">
      <input type="submit" value="아이디 / 비밀번호  찾기" class="login_BTN">
    </form>
